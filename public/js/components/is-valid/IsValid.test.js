...
describe("IsValid.email()", () => {
  ...
  test("biggest possible", () => {
    const [err, status] = IsValid.email(
      "very-long-firstname-and-lastname@very-long-website-name-for-real-true-story-bro.com.xyz"
    );
    expect(err).toBe(false);
    expect(status).toBe("OK");
  });
  ...
  test("one to big (local part)", () => {
    const [err, status] = IsValid.email(
      "very-long-firstname-and-lastname2@very-long-website-name-for-real-true-story-bro.com.xyz"
    );
    expect(err).toBe(true);
    expect(status).toBe("Negali buti maziau nei 6 ir daugiau nei 87 simboliu");
  });
  test("one to big (domain part)", () => {
    const [err, status] = IsValid.email(
      "very-long-firstname-and-lastname@very-long-website-name-for-real-true-story-bro2.com.xyz"
    );
    expect(err).toBe(true);
    expect(status).toBe("Negali buti maziau nei 6 ir daugiau nei 87 simboliu");
  });
...
describe("IsValid.password()", () => {
  ...
  test("biggest possible", () => {
    const [err, status] = IsValid.password(
      "PetrasPetrainis12345PetrasPetrainis12345PetrasPetrainis12345PetrasPetrainis12345PetrasPetrainis12345"
    );
    expect(err).toBe(false);
    expect(status).toBe("OK");
  });
  ...
  test("one to big", () => {
    const [err, status] = IsValid.password(
      "PetrasPetrainis12345PetrasPetrainis12345PetrasPetrainis12345PetrasPetrainis12345PetrasPetrainis123456"
    );
    expect(err).toBe(true);
    expect(status).toBe("Negali buti maziau nei 8 ir daugiau nei 100 simboliu");
  });
